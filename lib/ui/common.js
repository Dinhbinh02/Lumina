                ...
                <div class="lumina-input-bar" id="input-bar">
                    ...
                    <div class="lumina-trailing-group">
                        ...
                        <button class="lumina-mic-btn" id="mic-btn" title="Voice Input">
                            <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><rect x="7" y="10" width="2" height="6" rx="1"/><rect x="11" y="6" width="2" height="12" rx="1"/><rect x="15" y="10" width="2" height="6" rx="1"/><path d="M19 2l.6 1.8 1.8.6-1.8.6-.6 1.8-.6-1.8-1.8-.6 1.8-.6L19 2z"/></svg>
                        </button>
