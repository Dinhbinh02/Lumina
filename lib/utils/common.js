class LuminaChatUI {
    ...
    _getWebChipsContainer() {
        return this.container?.querySelector('#web-chips-container') || document.getElementById('web-chips-container');
    }
    ...
    _updatePinnedQuestionChip() {
        ...
        const chipsContainer = this._getWebChipsContainer();
        ...
        if (this._pinnedQuestionChipEl.parentElement !== chipsContainer) {
            chipsContainer.appendChild(this._pinnedQuestionChipEl);
        }
    }
    ...
    static applyViewportMinHeight(entry, container, inputWrapper) {
        ...
        if (viewportHeight > 0) {
            ...
            console.log('[LuminaChatUI] Applying min-height:', (viewportHeight - paddingOffset) + 'px', 'to entry:', entry);
                    ...
                    <div class="lumina-left-actions">
                         ...
                         <div class="lumina-actions-dropdown-wrapper" id="tools-wrapper">
                              ...
                              <div class="lumina-tools-dropdown" id="tools-dropdown">
                                  <div class="lumina-dropdown-header" style="padding: 8px 12px; font-size: 11px; font-weight: 700; color: var(--lumina-text-secondary); text-transform: uppercase; letter-spacing: 0.02em;">Actions</div>
