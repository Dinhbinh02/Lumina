class LuminaChatUI {
    ...
    initListeners(container) {
        ...
        container.addEventListener('mousedown', (e) => {
            ...
            if (questionBubble) {
                ...
                const editable = questionBubble.querySelector('.lumina-question-content[contenteditable="true"], div[contenteditable="true"]');
                if (editable) {
                ...
                if (!questionBubble.classList.contains('lumina-question-editing')) {
                    e.preventDefault();
    ...
    enterQuestionEditMode(questionDiv) {
        ...
        questionDiv.classList.add('lumina-question-editing', 'lumina-answer-editing');
    ...
    exitQuestionEditMode(questionDiv, save = false) {
        ...
        if (save) {
            ...
            questionDiv.classList.remove('lumina-question-editing');
            questionDiv.classList.remove('lumina-answer-editing');
