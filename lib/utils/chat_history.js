        ...
        while (i < chatData.messages.length) {
            ...
            if (msg.type === 'question') {
                ...
                if (hasTag) {
                    ...
                    questionDiv.innerHTML = `<div contenteditable="true"><span class="lumina-selected-text-tag" contenteditable="false">${tagContent}</span> ${taglessText}</div>`;
                } else {
                    questionDiv.innerHTML = `<div contenteditable="true">${cleanMsgContent}</div>`;
                }
