// --- DOM Memory Bloat Prevention Polyfill ---
(function() {
    ...
    if (typeof Element !== 'undefined' && Element.prototype) {
        ...
        Element.prototype.setAttribute = function(name, value) {
            if (name === 'data-raw-text') {
                ...
                // Put a truncated version in the DOM for debugging/selectors to prevent memory bloat
...
const ChatHistoryManager = {
    ...
    async restoreChat(chatData, historyContainer = null, targetIndex = null) {
        ...
        // Revoke previously active blob URLs to free memory
        const globalObj = typeof window !== 'undefined' ? window : (typeof globalThis !== 'undefined' ? globalThis : {});
