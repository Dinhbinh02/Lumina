    ...
    async getSystemPromptAddition() {
        return new Promise((resolve) => {
            chrome.storage.local.get([
                ...
                // 2. Base Style & Tone / Characteristics
                let toneParts = [];
                ...
                const toneMap = {
                    ...
                    efficient: 'Concise, plain, and direct. Deliver answers with minimal fluff, getting straight to the point. Focus on brevity and speed.',
