...
async function sparksLoad() {
    ...
    for (const [id, defSpark] of Object.entries(DEFAULT_SPARKS)) {
        ...
        if (!existing) {
            ...
            if (id === 'spark_samsung_qa_assistant' && (!existing.instructions || !existing.instructions.includes('WAIT_FOR_CHECK_EXTERNAL') || !existing.instructions.includes('Avoid verbose formatting'))) {
