    ...
    async showDetailsModal(date, value) {
            ...
            body.innerHTML = `
                <tr>
                    <td colspan="4" style="text-align:center; padding: 40px 20px;">
                        ...
                        <button id="reviveBtn" class="btn-primary" style="padding: 8px 16px; font-size: 0.75em;">Revive this day</button>
                    </td>
                </tr>
            `;
        ...
        try {
            ...
            body.innerHTML = dayRevs.map(r => {
                ...
                return `
                    <tr>
                        <td style="padding: 12px; border-bottom: 1px solid #f5f5f7; font-size: 0.6875em; color: #666;">${r.cardId}</td>
